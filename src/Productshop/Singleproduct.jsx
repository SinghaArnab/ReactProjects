...
<div className='min-h-[80vh] w-[50%] flex justify-center items-center'>
          ...
          <div className="show h-[80%] w-[60%] flex flex-col justify-center items-center " key={getitems.id}>
            ...
            <div>
                ...
                <div className="back"><button className='bg-black text-white m-3  h-[35px] w-[150px] hover:bg-[crimson]'  onClick={()=>navigate("/Product")}>Back</button></div>
                </div>
